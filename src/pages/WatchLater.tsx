  ...
  if (!user) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] text-ice-muted">
        <h2 className="text-2xl font-bold mb-4">Войдите, чтобы видеть список "Смотреть позже"</h2>
      </div>
    );
  }
  ...
  return (
    <div className="p-4 md:p-6 max-w-[1400px] mx-auto">
      <div className="flex items-center gap-3 mb-8">
        <Clock className="w-6 h-6 text-ice-accent" />
        <h1 className="text-2xl md:text-3xl font-bold">Смотреть позже</h1>
      </div>
