import { Search, Menu, Video, Bell, User as UserIcon, LogIn, LogOut } from 'lucide-react';
  ...
  const handleLogin = async () => {
    try {
      ...
      if (error.code === 'auth/popup-closed-by-user') {
        toast.error('Login window was closed. Please try again or check your browser settings.');
